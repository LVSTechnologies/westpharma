...
namespace YoutubePlayer.ViewModels
{
    public class YoutubeViewModel : INotifyPropertyChanged
    {
        ...
        private const string ApiKey = Constants.ApiKey;
        ...
        public YoutubeViewModel()
        {
            ...
            InitDataAsync().GetAwaiter();
        }

        private async void PlayYouTubeVideo(object i)
        {
            var youTubeItem = i as YoutubeItem;


            if (youTubeItem == null)
                return;
            string url = Constants.watchUrlBase + youTubeItem.VideoId;
